...
قم بتقييم المشروع وفق المعايير التالية (مجموع 50 نقطة):

1. **الابتكار والإبداع** (0-10 نقاط): هل الفكرة مبتكرة وجديدة؟
2. **الجدوى التقنية** (0-15 نقطة): هل المشروع قابل للتنفيذ تقنياً؟
3. **حل المشكلة** (0-10 نقاط): هل يحل المشروع مشكلة حقيقية بشكل فعال؟
4. **الوصف التقني** (0-10 نقاط): هل الوصف التقني دقيق ومفصل؟
5. **المرجع العلمي** (0-5 نقاط): هل المرجع العلمي مناسب وداعم للفكرة؟

أجب بصيغة JSON فقط كالتالي:
{{
    "total_score": <مجموع النقاط من 50>,
    "detailed_scores": {{
...
- المرجع العلمي يحتاج لمصادر إضافية
    ...
    def calculate_final_score(
        ...
        # 50% للإداريين (موزعة حسب الأوزان)
        # 50% لل AI
